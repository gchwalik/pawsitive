...
function DeletePlaceForm({ 
  ...
  return (
    <>
      ...
      <p className='font-medium text-center pb-4 text-rose-800'>Are you sure you want to delete {`${place.name}`}?</p>
      <ButtonContainer>
        <button onClick={() => onSubmit(place.id)} className="btn btn-danger">Yes</button>
